    ...
    <>
      ...
      <header className="m-auto box-border bg-black text-white">
        <div className="mr-auto ml-auto box-border flex h-12 w-3/4 items-center">
          <p className="flex-1 text-center text-xs md:text-base">
            ...
            <span className="font-bold underline hover:cursor-pointer hover:text-blue-800">
              Shop Now
            </span>
          </p>
      ...
      <nav>
        <div className="m-auto mt-10 flex h-11 w-3/4">
          ...
          <ul className="mt-auto mb-auto ml-auto flex gap-1 text-xs md:gap-5 md:text-base">
            <Link to={"/home"}>
          ...
          <div className="mt-auto mb-auto ml-auto flex">
            <div className="flex rounded-sm bg-gray-200 md:mr-2">
              ...
              ></input>
              <svg
                className="mt-auto mr-2 mb-auto h-6 w-6 text-gray-800 transition-all duration-300 hover:scale-95"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <Link to={"/wishlist"}>
              <svg
                className="mt-auto mb-auto h-6 w-6 text-gray-800 transition-all duration-300 hover:scale-90 md:mr-2"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
            ...
            <Link to={"/cart"}>
              <svg
                className="mt-auto mb-auto h-6 w-6 text-gray-800 transition-all duration-300 hover:scale-90"
                aria-hidden="true"
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
